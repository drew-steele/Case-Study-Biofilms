...
extracting cell data form pointpattern object
...
```{r}
redOG <- read.csv("data/test/redPAA48.csv")
```
...
neighboursInfo <- markstat(pat_new, countAliveDeadNeighbors, R = 15)

donemaybe <- t(neighboursInfo)
