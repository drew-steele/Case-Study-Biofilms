...
```{r}
inputDir <- "data/3750_24h_Repeat Oct 2020"
inputName <- "3750 20min PAA 24hrs 1"
outputName <- "1_24_H2O2_20_3"
```
...
if(offsetPos == "y") {
  ...
  par(mfrow = c(1,2))
  plot(imgG[350:370, 477:497]*4)
  plot(imgR[350:370, 477:497]*4)

  osR=mean(imgR[350:370, 477:497])
  osG=mean(imgG[350:370, 477:497])
