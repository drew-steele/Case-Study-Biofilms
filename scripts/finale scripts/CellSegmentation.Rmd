...
if(offsetPos == "y") {
  ...
  par(mfrow = c(1,2))
  plot(imgG[619:639, 441:461]*4)
  plot(imgR[619:639, 441:461]*4)

  osR=mean(imgR[619:639, 441:461])
  osG=mean(imgG[619:639, 441:461])
...
varVal <- c(thGvalue, thRvalue, rRatioValue, offsetRegion, sum(imgRo), sum(imgGo))
